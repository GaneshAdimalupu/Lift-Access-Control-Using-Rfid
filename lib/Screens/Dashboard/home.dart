  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<LiftUsage>>(
      ...
      builder: (context, snapshot) {
        ...
        liftUsageByDate = addPadding(liftUsageByDate);
              ...
              children: [
                ...
                Container(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: SizedBox(
                      width: (liftUsageByDate.length - 2) *
                      ...
                      child: SfCartesianChart(
                        ...
                        primaryXAxis: CategoryAxis(
                          ...
                          majorTickLines:
                              const MajorTickLines(color: Colors.green),
                          axisLine: const AxisLine(color: Colors.blue),
                          edgeLabelPlacement: EdgeLabelPlacement.shift,
                        ),
                        primaryYAxis: NumericAxis(
                          minimum: 0,
                          maximum: liftUsageByDate.values.reduce(max) +
                              2, // Adjust maximum to create gap
                          interval: 1,
                          majorGridLines: const MajorGridLines(width: 0),
                          majorTickLines:
                              const MajorTickLines(color: Colors.green),
